    ...
    case ECMA_OBJECT_TYPE_PSEUDO_ARRAY:
    {
      ...
      if (ecma_object_is_typedarray (object_p))
      {
        ...
        if (is_same)
        {
          ...
          return ecma_get_typedarray_element (info.buffer_p + byte_pos, info.array_buffer_p, num, info.length, info.id);
        }
      }
#endif /* JERRY_BUILTIN_TYPEDARRAY */
    ...
    case ECMA_OBJECT_TYPE_PSEUDO_ARRAY:
    {
      ...
      if (ecma_object_is_typedarray (object_p))
      {
        ...
        if (is_same)
        {
          ecma_typedarray_info_t info = ecma_typedarray_get_info (object_p);
          uint32_t byte_pos = (uint32_t) num << info.shift;
          return ecma_set_typedarray_element (info.buffer_p + byte_pos,
                                              info.array_buffer_p,
                                              value, num, info.length, info.id);
        }
      }
#endif /* JERRY_BUILTIN_TYPEDARRAY */
      break;
  ...
  if (ecma_object_is_typedarray (object_p))
  {
    if (!ecma_prop_name_is_symbol (property_name_p))
    {
      ...
      if (is_same)
      {
        ...
        value = ecma_get_typedarray_element (info.buffer_p + byte_pos,
                                             info.array_buffer_p,
        ...
        {
          if (ECMA_PROPERTY_GET_VALUE & ECMA_PROPERTY_GET_VALUE)
          {
            property_ref.virtual_value = value;
          }
          else
          {
          ...
          property = ECMA_PROPERTY_ENUMERABLE_WRITABLE | ECMA_PROPERTY_VIRTUAL;
        }
        else
        {
